...
Source code (Xbox protocol within Android) : AOSP common/drivers/input/joystick/xpad.c

源码依据（android源码支持的xbox协议）：AOSP common/drivers/input/joystick/xpad.c

github code file：https://github.com/paroj/xpad/blob/master/xpad.c
...
Can support the vast majority of handle protocol types（可以支持绝大多数的手柄协议类型）
